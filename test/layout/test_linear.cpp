...
TEST(TestLinear, shape_0) {
  auto stride = make_stride(make_stride(Int<a1>{}, Int<b1>{}),
                            make_stride(Int<c1>{}, Int<d1>{}));
  auto index = make_index(make_index(DynamicInt{a2}, DynamicInt{b2}),
                          make_index(DynamicInt{c2}, DynamicInt{d2}));
...
TEST(TestLinear, shape_1) {
  ...
  auto index =
      make_index(DynamicInt{a2}, make_index(DynamicInt{c2}, DynamicInt{d2}));
...
TEST(TestLinear, shape_3) {
  auto stride = make_stride(make_stride(Int<a1>{}, Int<b1>{}, Int<c1>{}),
                            make_stride(Int<d1>{}, Int<e1>{}, Int<f1>{}));
  auto index =
      make_index(make_index(DynamicInt{a2}, DynamicInt{b2}, DynamicInt{c2}),
